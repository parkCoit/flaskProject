...
midwest = pd.read_csv("../../../../static/data/dam/pd_sample/midwest.csv")
...
class MidWest:
    def __init__(self):
        self.midwest = pd.read_csv("../../../../static/data/dam/pd_sample/midwest.csv")
    ...
    def pct_hist(self):
        ...
        mw['pct'].plot.hist()
        plt.savefig('C:/Users/bitcamp/PycharmProjects/flaskProject/static/save/dam/pd_sample/midwest_hist.png')
    ...
    def var_large_small(self):
        ...
        plt.savefig('C:/Users/bitcamp/PycharmProjects/flaskProject/static/save/dam/pd_sample/midwest_var.png')
